...
<script>
    $.ajax({
        type: "POST",
        cache: false,
        url: '<?php echo base_url(); ?>/Serviceslocation/show_location_building',
        dataType: 'json',
        data: {},
        success: function(output) {
            console.log(output)
            const tabelLokasi = $('#tabelLokasi').dataTable();

            tabelLokasi.fnClearTable();
            ...
            for (var i = 0; i < output.length; i++) {
                ...
                tabelLokasi.fnAddData([
                    "" + outputDataBaris.building_name + "",
