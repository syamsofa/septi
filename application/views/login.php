                                    ...
                                    <div class="card-body">
                                        <form id="formLogin">
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="username" type="tesxt" placeholder="User Community" />
                                                <label for="inputEmail">Username</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="password" type="password" placeholder="Password Community" />
